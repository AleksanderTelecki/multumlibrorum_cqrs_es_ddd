...
namespace Product.Domain.Migrations
{
    ...
    [Migration("20231015093702_ManyToMany4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product.Domain.Repository.Entity.BookPromotionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PromotedBooksId");

                    b.HasIndex("PromotionsId");

                    b.ToTable("BookPromotions", "Product", t =>
                        {
                            t.Property("BookId")
                                .HasColumnName("BookId1");

                            t.Property("PromotionId")
                                .HasColumnName("PromotionId1");
                        });
                });
